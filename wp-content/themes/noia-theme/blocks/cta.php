...
<?php } ?>
	...
	<?php if ( $linkleft ) { ?>
		<div class="cta--links-item">
			<a href="<?php echo $linkleft['url']; ?>"><p class="heading-2"><?php echo $linkleft['title']; ?></p> <div class="arrow"><svg width="100" height="31" viewBox="0 0 150 47" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<?php if ( $linkright ) { ?>
		<div class="cta--links-item">
			<a href="<?php echo $linkright['url']; ?>"><p class="heading-2"><?php echo $linkright['title']; ?></p> <div class="arrow"><svg width="100" height="31" viewBox="0 0 150 47" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M150 23.5L110 0.405989V46.594L150 23.5ZM0 27.5H114V19.5H0V27.5Z" fill="currentColor"></path>
		</svg></div></a>
		</div>
	<?php } ?>

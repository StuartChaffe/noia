...
<?php } else { ?>
	...
	<?php if ( $videomobile ) { ?><video class="video video--full hidedesktop" src="<?php echo $videomobile['url']; ?>" loop="false" muted="" data-poster="" preload="" playsinline="" scrollspy="" autoplay="true" poster=""></video><?php } ?>
<?php } ?>	
<!-- </div> -->